# -*- coding: utf-8 -*-
"""
Created on Sat May 27 03:16:06 2023
...
uurrmm=usersratings.merge(movies, how='inner')
...
ZZZ=mlb.fit_transform(Frames['Genres'])
Y= pd.DataFrame(ZZZ)
print(Y)


noms_colonnes = ['Action','Adventure', 'Animation', "Children's", 'Comedy', 'Crime',
 'Documentary', 'Drama', 'Fantasy', 'Film-Noir', 'Horror', 'Musical', 'Mystery',
 'Romance', 'Sci-Fi', 'Thriller', 'War', 'Western']
Y.columns = noms_colonnes
...
XTrain,XTest,yTrain,yTest = model_selection.train_test_split(X,Y,test_size =0.2,
                                                             random_state=1)
modelMc = Sequential()
modelMc.add(Dense(units=80,input_dim=3,activation="relu"))
modelMc.add(Dense(units=80,activation="relu"))
modelMc.add(Dense(units=80,activation="relu"))
modelMc.add(Dense(units=80,activation="relu"))
modelMc.add(Dense(units=80,activation="relu"))
...
history=modelMc.fit(XTrain,yTrain,
                    verbose=1,epochs=200,batch_size=200,
...
#*********** Movies Sentiment Analysis (SA files )*****************************

"""
#*******sentiment_scores function : Sentence Sentiment Analysis **************
